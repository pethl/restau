...
Error.create(ref: '999999105', msg: 'The last booking time for a Sunday is 3.30, please amend your booking time and try again.', desc: 'Validation - Booking enquiry : User tried to book outside food serve hours on Sun.')
...
Error.create(ref: '999999107', msg: 'We are sorry, we already have a number of large parties booked for this day and cannot accommodate your group on this day.', desc: 'Validation - Booking enquiry. Cannot accommodate more than PARAM-MAX big parties of PARAM-BIG size.')
Error.create(ref: '999999108', msg: 'We are sorry, we already have a number of large parties booked for this day and cannot accommodate your group on this day.', desc: 'Validation - Booking enquiry. Cannot accommodate more than PARAM-MAX large parties of PARAM-LARGE size.')
