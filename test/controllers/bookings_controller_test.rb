...
#  end
  ...
  test "should create booking" do
    assert_difference('Booking.count') do
      post :create, booking: { accessible: @booking.accessible, booking_date: @booking.booking_date, booking_time: @booking.booking_time, child_friendly: @booking.child_friendly, customer_id: @booking.customer_id, number_of_diners: @booking.number_of_diners, table_id: @booking.table_id }
    end
